const en = {
  common: {
    ...
    messages: {
      parameterValidationFailed:
        "Argument validation failed. Please review your inputs.",
    },
    errors: {
  ...
  navigation: {
    ...
    tools: {
      ...
      aptosGasSchedule: {
        ...
        description:
          "Browse and search Aptos gas schedule entries with filtering and sorting.",
      },
    },
  },
  home: {
  ...
  aptos: {
    ...
    signing: {
      ...
      notConnectedSummary:
        "Connect an Aptos wallet to enable one-click signing on this page.",
      reminderConnectAbove:
        "Use the wallet button above to connect your wallet before submitting.",
      walletConnectedTitle: "Connected Wallet",
      walletAddress: "Address",
      walletNetwork: "Wallet network",
      disconnect: "Disconnect",
      connectPrompt:
        "Choose an installed wallet to connect (powered by Aptos Wallet Adapter React).",
      notDetected:
        "No compatible wallet detected. Install Petra or another Aptos wallet extension.",
      networkMismatch:
        "Your wallet network is {walletNetwork}, which differs from the selected {selectedNetwork}. Submission may fail.",
  ...
  aptosAbi: {
    ...
    description:
      "Explore module ABI definitions, view function signatures, struct definitions, and bytecode.",
    actions: {
      loadAbi: "Load ABI",
  ...
  bcs: {
    ...
    description:
      "Encode and decode common Aptos primitives, addresses, and byte vectors to verify payloads quickly.",
    mode: {
      encode: "BCS Encode",
      decode: "BCS Decode",
    },
    ...
    typeSelect: {
      ...
      wrapperHint:
        "Wrappers apply outside-in. Combine vector<> and Option<> to compose complex types.",
    ...
    encode: {
      ...
      jsonHint:
        "Use JSON to describe nested vectors or options. Use null for Option::None.",
  ...
  gasSchedule: {
    ...
    description:
      "Browse, search, and analyze Aptos gas schedule entries from the chain.",
    actions: {
