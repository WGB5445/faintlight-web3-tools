const zh = {
  ...
  layout: {
    ...
    title: "Web3 多网络实验室",
    subtitle:
      "以链路为维度组织工具，轻松扩展到 Aptos 之外仍然保持清晰的工作流入口。",
    status: {
      chain: "链",
      tool: "工具",
    },
    footer:
      "想要支持更多链路？在 src/lib/tools.ts 中扩展配置即可无缝接入新的页面。",
  },
  navigation: {
    groups: {
      overview: {
  ...
  home: {
    title: "Web3 多工具工作台",
    description:
      "从左侧选择链路与工具，快速构建、检查并提交 Aptos 交易，或在 BCS 工具中实验参数。",
    support: {
      title: "当前支持",
      items: [
  ...
  aptos: {
    title: "Aptos 合约交互",
    description:
      "连接 Aptos 钱包或使用私钥，自动加载模块 ABI，通过类型感知的输入构建并提交交易。",
    network: {
      label: "网络选择",
      customOption: "自定义",
    ...
    signing: {
      ...
      disconnect: "断开连接",
      connectPrompt:
        "选择已安装的钱包进行连接（基于 Aptos Wallet Adapter React）。",
      notDetected: "未检测到兼容钱包，请先安装 Petra 等 Aptos 插件。",
      networkMismatch:
        "当前钱包网络为 {walletNetwork}，与选择的 {selectedNetwork} 不一致，提交可能失败。",
  ...
  bcs: {
    title: "BCS 编码 / 解码",
    description:
      "面向 Aptos 的常见原语、地址与字节向量，提供编码与解码能力，便于快速校验。",
    mode: {
      encode: "BCS 编码",
      decode: "BCS 解码",
    },
    ...
    encode: {
      ...
      jsonHint:
        "对嵌套的 vector 或 Option 使用 JSON 描述，Option::None 请填写 null。",
